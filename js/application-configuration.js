...
define(['angularAMD', 'angular-route', 'ui-bootstrap', 'angular-sanitize', 'blockUI','jQuery','bootstrap','charts' ], function (angularAMD) {
    ...
    app.config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider
           ...
           .when("/", angularAMD.route({
                ...
                templateUrl: function (rp) {  return 'views/login/login.html';  },               
                controllerUrl: "controller/login/loginController"            
            ...
            .when("/:section/:tree", angularAMD.route({
                ...
                resolve: {
                    ...
                    load: ['$q', '$rootScope', '$location', function ($q, $rootScope, $location) {
                        ...
                        var loadController = "controller/" + parentPath + "/" + controllerName + "Controller";                 
