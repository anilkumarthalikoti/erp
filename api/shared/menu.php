...
if(isset($_GET)){
    ...
    if($_GET['action']=='menu'){
        ...
        $rows=$conn->query("select module_name,page_action,pageName from erp_modules m, erp_pages p  where m.enabled='Y' and p.page_enabled='Y' and m.module_id= p.module_id order by priority,page_id");
   $links=array();
